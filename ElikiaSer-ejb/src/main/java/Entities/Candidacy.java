...
@OneToOne
@JoinColumn(name="FK_interview_ID") private Interview interview; 


public Interview getIntervie() {
	return interview;
}

public void setIntervie(Interview intervie) {
	this.interview = intervie;
}
